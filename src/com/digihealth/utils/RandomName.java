...
public class RandomName {
	...
	private static String firstName = "赵钱孙李周吴郑王冯陈褚卫蒋沈韩杨朱秦尤许何吕施张孔曹严华金魏陶姜戚谢邹喻水窦章云苏潘葛奚范彭郎鲁韦马苗方俞任袁柳鲍史唐费岑薛雷贺倪汤滕殷罗毕郝邬安常于傅皮卞齐康伍余元顾孟黄穆萧尹姚邵湛汪祁毛禹狄臧成戴宋茅庞熊纪舒屈项祝董梁杜阮蓝闵席季贾路娄危江童颜郭梅盛林刁钟徐邱骆高夏蔡田樊胡凌霍虞万柯管卢莫房缪宗丁贲邓郁单洪包诸左石崔吉龚程邢裴陆魏靳井段谷侯郗刘姜";
...
//		int sex = getNum(0, 1);
	...
	public static void main(String[] args) {
		System.out.println(getAddress("女"));
	}
