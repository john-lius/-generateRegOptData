...
public class DocAnaesSummaryAppendixGen {
	 ...
	 * 口咽通道
	 */
	private Integer oropharynxChannel;
	...
	public void setAnaSumAppGenId(String anaSumAppGenId) {
		this.anaSumAppGenId = anaSumAppGenId;
	}
	...
	public Integer getOropharynxChannel() {
		return oropharynxChannel;
	}

	public void setOropharynxChannel(Integer oropharynxChannel) {
		this.oropharynxChannel = oropharynxChannel;
	}
	...
	public Integer getAnalgesic() {
		return analgesic;
	}

	public void setAnalgesic(Integer analgesic) {
