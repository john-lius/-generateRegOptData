...
public class DocAnaesSummarySql {
	...
	public static final String deleteByRegOptId = "DELETE FROM doc_anaes_summary WHERE regOptId IN(SELECT t.regOptId FROM bas_reg_opt t WHERE t.beid = ? AND t.name LIKE ?)";
}
